<div style="margin-left: 300px;">
	<form action="edit_list_music.php?id=<?php echo $id; ?>" method="post">	
		<h2 style="color: #FF9999; margin-left: 100px;">Sửa thông tin bài hát</h2>		
			...
			<div>
				<input style="height: 30px; width: 500px; color: #00CC99;" type="text" name="singer" placeholder="Tên ca sĩ" value="<?php echo $row['sname']; ?>" required>
				<div style="color: #A020F0;">Tên ca sĩ</div>
			</div>
			<div>
				<input style="height: 30px; width: 500px; color: #00CC66;" type="text" name="musician" placeholder="Tên nhạc sĩ" value="<?php echo $row['mname']; ?>" required>
