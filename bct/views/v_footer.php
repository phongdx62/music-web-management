<!-- ======================== Footer ======================== -->
  ...
  <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #181412;font-family: 'Helvetica',sans-serif; height: 40px;">
    ...
    <link rel="stylesheet" type="text/css" href="./public/core/js/audioplayerengine/initaudioplayer-1.css">
    <script src="./public/core/js/audioplayerengine/initaudioplayer-1.js"></script>
